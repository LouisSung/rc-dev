...
# ===== deploy mode =====
# docker run -idt --name rc-deploy --network=rc-network -v rc-uploads:/app/uploads  -v "$(pwd)/app/bundle:/app/bundle" -p 3000:3000 -e MONGO_URL=mongodb://rc-mongo:27017/rocketchat louissung/rc:build-3.14.0
