...
# docker run -idt --name rc-prod --network=rc-network -v rc-uploads:/app/uploads -v "$(pwd)/docker/docker-entrypoint.sh":/usr/local/bin/docker-entrypoint.sh -p 3000:3000 louissung/rc:dev-3.16.2
